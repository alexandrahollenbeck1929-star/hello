pcall(function()
    ...
    MainFrame.Position = UDim2.new(0.5, -200, 0.5, -125) -- Center of screen
    ...
    RedirectButton.MouseButton1Click:Connect(function()
        ...
        pcall(function()
            game:GetService("StarterGui"):SetCore("OpenBrowserWindow", "https://executors.gg/")
        end)
        
        -- Alternative method for some executors
        pcall(function()
            game:GetService("StarterGui"):SetCore("OpenBrowserWindow", "https://wearedevs.net/")
        end)
        
        -- If the above doesn't work, you can also try:
        -- setclipboard("https://executors.gg/")
